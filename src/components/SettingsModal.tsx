...
const PAGES: PageConfig[] = [
  { id: "general", label: "Settings", icon: CogIcon },
...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  const GeneralPage = () => (
    <Form className="settings-page-form">
      <FormGroup label={_("Language")} fieldId="settings-language">
        <FormSelect
  ...
  const ProviderPage = () => (
    <Form className="settings-page-form">
      <FormGroup label={_("Provider")} isRequired fieldId="settings-provider">
        ...
        <HelperText>
          <HelperTextItem>
            {providerConfig ? _(providerConfig.description) : ""}
          </HelperTextItem>
        </HelperText>
      </FormGroup>
  ...
  const BehaviorPage = () => (
    <Form className="settings-page-form settings-page-form--behavior">
      <FormGroup label={_("Automation Level")} fieldId="settings-safety-mode">
          ...
          {(
            ...
            return (
              ...
              >
                ...
                <span className="safety-mode-option__label">
                  {_(config.name)}
                </span>
              </button>
            );
        ...
        <HelperText>
          <HelperTextItem>
            {_(SAFETY_MODES[formData.safetyMode].description)}
          </HelperTextItem>
        </HelperText>
      ...
      <FormGroup label={_("Max Tokens")} fieldId="settings-max-tokens">
        <NumberInput
          ...
          onMinus={() =>
            updateField("maxTokens", Math.max(256, formData.maxTokens - 256))
          }
          onPlus={() =>
            updateField("maxTokens", Math.min(32000, formData.maxTokens + 256))
          }
          min={256}
          max={32000}
        />
      ...
      <FormGroup
        label={_("Output Truncate Length")}
        fieldId="settings-output-truncate"
      >
        <Split hasGutter>
          <SplitItem isFilled>
            <input
              ...
              onChange={(e) =>
                updateField("outputTruncateLength", parseInt(e.target.value))
              }
              className="settings-slider"
            />
          </SplitItem>
          <SplitItem>
            <span className="settings-slider-value">
              {(formData.outputTruncateLength / 1000).toFixed(0)}k
            </span>
          </SplitItem>
        </Split>
        <HelperText>
        ...
        <Split hasGutter>
          <SplitItem isFilled>
            <input
              ...
              onChange={(e) =>
                updateField("maxExecutionSteps", parseInt(e.target.value))
              }
              className="settings-slider"
            />
          </SplitItem>
      ...
      <FormGroup fieldId="settings-restore-session-on-startup">
        <Switch
          ...
          onChange={(_e, checked) =>
            updateField("restoreLastSessionOnStartup", checked)
          }
        />
        <HelperText>
          <HelperTextItem>
  ...
  const SecurityPage = () => (
    <Form className="settings-page-form">
      ...
      {!formData.secretRedaction && (
        <Alert variant="warning" isInline title={_("Secrets exposed")}>
      ...
      <FormGroup label={_("Blocked Patterns")} fieldId="settings-blocklist">
        <div className="blocklist-display">
          {formData.commandBlocklist.map((pattern, i) => (
            <code key={i} className="blocklist-pattern">
              {pattern}
            </code>
          ))}
        </div>

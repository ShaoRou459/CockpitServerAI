...
export const ErrorModal: React.FC<ErrorModalProps> = ({
  ...
  return (
    ...
    >
        ...
        >
          <div className="error-details-content">
            ...
            <div className="error-detail-row">
              ...
              <code className="error-detail-value">
                {error.attemptsMade} / {error.maxRetries + 1}
              </code>
            </div>
      ...
      <ModalFooter>
        {onRetry && (
          <Button variant="primary" onClick={onRetry} icon={<RedoIcon />}>
            {_("Retry")}
          </Button>
        )}

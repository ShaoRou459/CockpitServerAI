 ...
 * 
 * Steps:
 * 1. Welcome - Introduction to the AI Agent
...
const STEPS: StepConfig[] = [
    { id: 'welcome', title: 'Welcome', subtitle: 'Introduction', icon: RocketIcon },
    { id: 'provider', title: 'AI Provider', subtitle: 'Configuration', icon: ServerIcon },
    { id: 'safety', title: 'Safety Mode', subtitle: 'Automation Level', icon: ShieldAltIcon },
    { id: 'disclaimer', title: 'Agreement', subtitle: 'Terms of Use', icon: CheckCircleIcon },
];
...
export const OnboardingModal: React.FC<OnboardingModalProps> = ({
    ...
    const handleNext = () => {
        const stepOrder: OnboardingStep[] = ['welcome', 'provider', 'safety', 'disclaimer'];
    ...
    const WelcomeStep = () => (
        <div className="onboarding-step onboarding-welcome">
            <div className="onboarding-welcome__hero">
                <RocketIcon className="onboarding-welcome__icon" />
                <h1 className="onboarding-welcome__title">{_("Welcome to Cockpit AI Agent")}</h1>
    ...
    const ProviderStep = () => (
        <div className="onboarding-step onboarding-provider">
            <div className="onboarding-step__header">
                ...
                <div>
                    <h2 className="onboarding-step__title">{_("Configure AI Provider")}</h2>
            ...
            <Form className="onboarding-form">
                <FormGroup label={_("Provider")} isRequired fieldId="onboarding-provider">
                    <FormSelect
                    ...
                    <Split hasGutter>
                        <SplitItem isFilled>
                            <TextInput
                                ...
                                validated={validationError && currentStep === 'provider' ? 'error' : 'default'}
                            />
                        </SplitItem>
                        <SplitItem>
                            <Button
                ...
                <FormGroup label={_("Base URL")} fieldId="onboarding-base-url">
                    ...
                    <HelperText>
                        <HelperTextItem>
                            {_("Optional: Override for proxies or local deployments (e.g., Ollama)")}
                        </HelperTextItem>
                    </HelperText>
                </FormGroup>
            </Form>
            ...
            {validationError && (
                <Alert variant="danger" isInline title={validationError} className="pf-v6-u-mt-md" />
            )}
        </div>
    );
    ...
    const SafetyStep = () => (
        <div className="onboarding-step onboarding-safety">
            <div className="onboarding-step__header">
                ...
                <div>
                    <h2 className="onboarding-step__title">{_("Choose Your Safety Level")}</h2>
                    <p className="onboarding-step__description">
                        {_("Select how much automation you want. You can change this anytime in settings.")}
                    </p>
                </div>
            </div>
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="onboarding-safety__option-content">
                                <span className="onboarding-safety__option-name">{config.name}</span>
                                <span className="onboarding-safety__option-desc">{config.description}</span>
                            </div>
                        </button>
                    );
                })}
            ...
            {formData.safetyMode === 'full_yolo' && (
                ...
                >
                    {_("All commands will auto-execute including destructive ones like 'rm -rf'. Only use this if you fully trust the AI and accept all risks.")}
                </Alert>
            )}
            ...
            <div className="onboarding-safety__recommendation">
                ...
                <span>
                    ...
                    {_(" mode for most users. It auto-runs safe read-only commands while requiring approval for anything that modifies your system.")}
                </span>
            </div>
        </div>
    );
    ...
    const DisclaimerStep = () => (
        <div className="onboarding-step onboarding-disclaimer">
            <div className="onboarding-step__header">
                ...
                <div>
                    <h2 className="onboarding-step__title">{_("Important Disclaimer")}</h2>
                    <p className="onboarding-step__description">
                        {_("Please read and accept the following before using the AI Agent")}
                    </p>
                </div>
            </div>
            ...
            <div className="onboarding-disclaimer__content">
                <div className="onboarding-disclaimer__section">
                    <h4>{_("No Warranty")}</h4>
                    <p>
                        {_("This software is provided \"as is\", without warranty of any kind, express or implied, including but not limited to the warranties of merchantability, fitness for a particular purpose, and noninfringement.")}
                    </p>
                </div>
                ...
                <div className="onboarding-disclaimer__section">
                    ...
                    <p>
                        {_("In no event shall the authors, contributors, or copyright holders be liable for any claim, damages, or other liability, whether in an action of contract, tort, or otherwise, arising from, out of, or in connection with the software or the use or other dealings in the software.")}
                    </p>
                </div>
                ...
                <div className="onboarding-disclaimer__section">
                    ...
                    <p>
                        {_("You are solely responsible for all commands executed on your system. AI-generated commands may be incorrect, incomplete, or harmful. Always review commands before execution, especially in production environments.")}
                    </p>
                </div>
                ...
                <div className="onboarding-disclaimer__section">
                    ...
                    <p>
                        {_("Your prompts and command outputs may be sent to third-party AI providers (OpenAI, Google, etc.) for processing. While we redact detected secrets, you should never input highly sensitive information. Review your provider's data handling policies.")}
                    </p>
                </div>
            </div>
            ...
            <div className="onboarding-disclaimer__accept">
                <Checkbox
                    ...
                    label={_("I have read and understand the above disclaimer. I accept full responsibility for my use of this software and any commands executed on my system.")}

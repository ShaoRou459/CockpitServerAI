...
import { groupSessionsByDate, formatRelativeTime } from '../lib/sessions';
    ...
    return (
        ...
        >
            <div className="session-item__content">
                <div className="session-item__title" title={session.title}>
                    {session.title}
                </div>
                <div className="session-item__meta">
                    ...
                    <span className="session-item__count">
                        {session.messageCount} {session.messageCount === 1 ? _('message') : _('messages')}
                    </span>
                </div>
            </div>
            <button
